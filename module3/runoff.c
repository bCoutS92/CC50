...
// Record preference for valid vote
bool vote(int voter, int rank, string name)
{
    for (int i = 0; i < candidate_count; i++)
    {
...
// Votes for non-eliminated candidates
void tabulate(void)
{
    for (int i = 0; i < voter_count; i++)
    {
...
bool print_winner(void)
{
    int min = (int) round(voter_count / 2);
    for (int i = 0; i < candidate_count; i++)
    {
...
// Return minimum number of votes any remaining candidate has
int find_min(void)
{
    int min;
